...
trait HasSchedules
{
    ...
    {
        return $this->hasMany(config('koverae-billing.models.plan_subscription_schedule'), 'subscription_id', 'id');
    }

    /**
     * Future plan
     *
     * @param Plan $planCombination Plan or PlanCombination that will be the new one
     *
     * @return HasSchedules|\Koverae\KoveraeBilling\Models\PlanSubscription
     */
    public function toPlan(Plan $planCombination): self
    {
    ...
    public function getLatestSchedule(?Carbon $date = null)
    {
        ...
        return app(config('koverae-billing.models.plan_subscription_schedule'))
            ->pending($date)
