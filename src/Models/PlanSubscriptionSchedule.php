...
class PlanSubscriptionSchedule extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('koverae-billing.tables.plan_subscription_schedules'));
    }
    ...
    {
        return [
            'subscription_id' => 'required|integer|exists:' . config('koverae-billing.tables.plan_subscriptions') . ',id',
            'scheduled_at' => 'date'
        ];
    }
    ...
    {
        return $this->belongsTo(config('koverae-billing.models.plan_subscription'), 'subscription_id', 'id');
    }
