...
use Koverae\KoveraeBilling\Traits\HasSubscriptionPeriod;
use Koverae\KoveraeBilling\Traits\HasTrialPeriod;
...
class Plan extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('koverae-billing.tables.plans'));
    }
    ...
    {
        return [
            'tag' => 'required|max:150|unique:' . config('koverae-billing.tables.plans') . ',tag',
    ...
    {
        return $this->hasMany(config('koverae-billing.models.plan_combination'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('koverae-billing.models.plan_feature'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('koverae-billing.models.plan_subscription'), 'plan_id', 'id');
    }
